...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
                        ...
                        <xsl:otherwise>
                            ...
                            <xsl:choose>
                                <xsl:when test="$is_first_page">
                                    <xsl:call-template name="getCarouselSlide"/>
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <!-- New UI: add css files -->
            <link rel="stylesheet" href="{concat($theme-path, 'styles/Footer-Dark.css')}"/>
            <link rel="stylesheet" href="{concat($theme-path, 'styles/fonts/ionicons.min.css')}"/>
            <link rel="stylesheet" href="{concat($theme-path, 'styles/Features-Boxed.css')}"/>
                                ...
                                <li>
                                    <form id="ds-search-form" class="navbar-form" method="post">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="xmlui.general.search" i18n:attr="placeholder"/>
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" title="xmlui.general.go" i18n:attr="title" type="submit">
...
like: ?filtertype=subject&filter_relational_operator=equals&filter=keyword1 it appends the locale parameter with the ampersand (&) symbol -->
    ...
    <xsl:template name="getCarouselSlide">
        <!-- <div class="container-fluid"> -->
            <div id="homepage_Carousel_slide" class="carousel slide" data-ride="carousel">
                <!-- Indicators -->
                <ol class="carousel-indicators">
                    <li data-target="#homepage_Carousel_slide" data-slide-to="0" class="active"></li>
                    <li data-target="#homepage_Carousel_slide" data-slide-to="1"></li>
                    <li data-target="#homepage_Carousel_slide" data-slide-to="2"></li>
                </ol>

                <!-- Wrapper for slides -->
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="{concat($theme-path, 'images/one.jpg')}" style="width:100%;height:100%;"/>
                        <div class="carousel-caption">
                            <h3>Explore the Possibilities</h3>
                            <p>With over 170 degree programs, you can pursue your passions and design the future career you want. Click here to explore your opportunities.</p>
                            <a class="webcomm-carousel-actionLink" role="button" href="/web/academics" tabindex="-1">Find Your Major</a>
                        </div>
                    </div>

                    <div class="item">
                        <img src="{concat($theme-path, 'images/two.jpg')}" style="width:100%;height:100%;"/>
                        <div class="carousel-caption">
                            <h3>Be Part of the Tradition</h3>
                            <p>Be part of the tradition and join the Sooner Family. During their time in Norman, Sooners enjoy a wide variety of activities with the rich community on and off campus. Find your niche in the organizations, events, and programs happening year-round.</p>
                            <a class="webcomm-carousel-actionLink" role="button" href="/web/academics" tabindex="-1"> Learn More About Our History </a>
                        </div>
                    </div>
                    
                    <div class="item">
                        <img src="{concat($theme-path, 'images/three.jpg')}" style="width:100%;height:100%;"/>
                        <div class="carousel-caption">
                            <h3>See Yourself Here</h3>
                            <p>Explore every corner of our campus–beautiful by day and night–in our expansive photo gallery.</p>
                            <a class="webcomm-carousel-actionLink" role="button" href="/web/academics" tabindex="-1"> See Photos of Campus </a>
                        </div>
                    </div>
                </div>

                <!-- Left and right controls -->
                <a class="left carousel-control" href="#homepage_Carousel_slide" data-slide="prev">
                <span class="glyphicon glyphicon-chevron-left"></span>
                <span class="sr-only">Previous</span>
                </a>
                <a class="right carousel-control" href="#homepage_Carousel_slide" data-slide="next">
        ...
        <div class="footer-dark">
            <footer>
                <div class="container">
                        ...
                        <div class="col-sm-6 col-md-3 item">
                            <div class="footerColumn span4">
                                <div class="footerlogo">
                                    <img alt="OU" src="{concat($theme-path, 'images/hznu-logo.jpg')}" class="footerlogoimg" />
                                </div>
                                <div class="footeraddress">
                                    <a href="#"><b>杭州师范大学</b></a><br/>余杭区仓前街道海曙路58号, <br/>
                                    Hangzhou, 311121<br/>
                                    0571-28865193<br/>
                                </div>       
                            </div>
                    ...
                    <p class="copyright">University Name © 2018</p>
                </div>
            </footer>
        </div>  
    </xsl:template>
