...
-->
    ...
    <xsl:template match="dri:p">
        <!-- New UI -->
        <xsl:if test="not(parent::node()[@n='news' or @n='comunity-browser'] or @n='recent-submission-view-more')">
            <p>
                <xsl:call-template name="standardAttributes">
    ...
    <xsl:template match="dri:head" priority="1">
        <h3>
            <xsl:choose>
                <xsl:when test="$is_first_page">
                        <xsl:call-template name="standardAttributes">
                            <xsl:with-param name="class">intro</xsl:with-param>
                        </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                        <xsl:call-template name="standardAttributes">
    ...
    <xsl:template match="dri:div/dri:head" priority="3">
        <!-- New UI -->
        <xsl:choose>
            <xsl:when test="parent::dri:div[@n='news']">
                <div class="container">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <xsl:value-of select="/dri:document//dri:div[@n='news']/dri:p" />
                            </div>
                    </div>
                </div>
            </xsl:when>
            <xsl:when test="parent::dri:div[@n='comunity-browser']">
                &#160;
            </xsl:when>
            <xsl:when test="parent::dri:div[@n='site-recent-submission']">
                &#160;
            </xsl:when>
            <xsl:otherwise>
                <xsl:apply-templates />
